 ...
 * </p>
 * <ul>
 *   <li>{@link modelConverter.use_language.uml.impl.AttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link modelConverter.use_language.uml.impl.AttributeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends OwnedParameterImpl implements Attribute
{
  /**
  ...
  public void setType(SimpleTypes newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.ATTRIBUTE__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.ATTRIBUTE__TYPE, null, msgs);
