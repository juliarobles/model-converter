...
public class USEParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, USEGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSimpleTypesAccess().getReferendedAssignment_2(), "rule__SimpleTypes__ReferendedAssignment_2");
			...
			builder.put(grammarAccess.getOCLExpressionAccess().getOwnedExpressionAssignment(), "rule__OCLExpression__OwnedExpressionAssignment");
