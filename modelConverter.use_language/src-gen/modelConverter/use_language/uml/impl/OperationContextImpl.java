 ...
 * </p>
 * <ul>
 *   <li>{@link modelConverter.use_language.uml.impl.OperationContextImpl#getConstrains <em>Constrains</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationContextImpl extends ContextsTypeImpl implements OperationContext
{
  ...
  {
    return UmlPackage.Literals.OPERATION_CONTEXT;
  }
  ...
  public NotificationChain basicSetConstrains(OperationConstraints newConstrains, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlPackage.OPERATION_CONTEXT__CONSTRAINS, oldConstrains, newConstrains);
  ...
  public void setConstrains(OperationConstraints newConstrains)
  {
    if (newConstrains != constrains)
    {
      ...
      if (constrains != null)
        msgs = ((InternalEObject)constrains).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.OPERATION_CONTEXT__CONSTRAINS, null, msgs);
      if (newConstrains != null)
        msgs = ((InternalEObject)newConstrains).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.OPERATION_CONTEXT__CONSTRAINS, null, msgs);
      msgs = basicSetConstrains(newConstrains, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.OPERATION_CONTEXT__CONSTRAINS, newConstrains, newConstrains));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmlPackage.OPERATION_CONTEXT__CONSTRAINS:
